class HostInterceptUtils {
  static const int TYPE_NOTHING = 0;
  static const int TYPE_ONLY_WHITE = 1;
  static const int TYPE_INTERCEPT_BLACK = 2;
  ...
  static bool isWhiteHost(String host) {
    return WHITE_HOST.contains(host);
  }

  static bool isBlackHost(String host) {
    return BLACK_HOST.contains(host);
  }

  static final WHITE_HOST = [
    'www.wanandroid.com',
    'study.163.com',
    'juejin.im',
    'juejin.cn',
